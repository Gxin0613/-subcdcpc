<template>
  <div class="num-range-picker">
    <input class="min-val" v-model="startVal" :placeholder="searchNumAttr.label + '开始'" @change="startValChange" />
    <span class="symbol"> ~ </span>
    <input class="max-val" v-model="endVal" :placeholder="searchNumAttr.label + '结束'" @change="endValChange" />
  </div>
</template>
