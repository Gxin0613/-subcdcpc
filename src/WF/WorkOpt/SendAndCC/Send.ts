...
/// 发送
/// </summary>
export class Send extends EntityMyPK {
  constructor(pkval?: string) {
    super('TS.WorkOpt.Send');
  ...
  public override get EnMap() {
    ...
    map.AddTBString(WorkOptAttr.SendDeptLeaders, null, '到部门领导', true, false, 0, 500, 10, true, null);
    ...
    map.AddTBString(WorkOptAttr.StarterName, null, '发起人', true, true, 0, 200, 10);
    ...
    map.AddTBString(WorkOptAttr.ToNodeName, null, '到达节点', false, true, 0, 100, 10, false, null);
    ...
    //部门选择
    map.SetPopTree(WorkOptAttr.SendDepts, GloWF.srcDepts, GloWF.srcDeptRoot, true, '500px', '500px', '选择部门', 'icon-people');
  ...
  public async SendFlow() {
    ...
    try {
      ...
      message.destroy(key); // 使用 key 来销毁消息
