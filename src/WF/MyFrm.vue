    ...
    <Spin :spinning="loading">
      ...
      <div v-else style="background-color: rgb(240, 242, 245); height: 100%">
        ...
        <div class="content wrapper" :style="contentStyle">
          <ChartFrm v-if="pagetype == 10 && frmData" :params="queryParams" ref="ChartFrmRef" :field-is-readonly="params.fieldIsReadonly" />
          <FrmFool v-if="(pagetype === 0 || pagetype === 8) && frmData" ref="basicData" :frmData="frmData" :fieldIsReadonly="true" :isReadonly="true" :params="queryParams" />
          <FrmSelf v-if="pagetype === 3 && node.FormType != 3 && frmData" ref="basicData" :frmData="frmData" :fieldIsReadonly="true" :isReadonly="true" :params="queryParams" />
...
<script lang="ts" setup>
  ...
  import FrmSelf from './CCForm/FrmSelf.vue';
  ...
  const queryParams = props.params.isComponent === true ? (props.params as any) : route.query || {};
  //初始化页面，判断当前流程表单类型
