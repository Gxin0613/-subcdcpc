...
export class GL_WorkerList extends PageBaseGenerList {
  ...
  async Init() {
    ...
    //定义列.
    this.Columns = [
      { Key: 'WorkID', Name: '人员账号', IsShow: true, DataType: DataType.AppString },
      { Key: 'FK_Emp', Name: '人员账号', IsShow: true, DataType: 1, width: 100 },
      { Key: 'FK_EmpT', Name: '人员名称', IsShow: true, DataType: 1, width: 100 },

      { Key: 'FK_Node', Name: '节点ID', IsShow: true, DataType: 1, width: 100 },
      { Key: 'NodeName', Name: '节点名称', IsShow: true, DataType: 1, width: 100 },

      { Key: 'IsPass', Name: '是否通过', IsShow: true, DataType: 1, width: 100 },

      { Key: 'SDT', Name: '应完成日期', IsShow: true, DataType: 1, width: 40 },
      { Key: 'RDT', Name: '记录时间(接受工作日期)', IsShow: true, DataType: 1, width: 66 },
      { Key: 'IsRead', Name: '是否读取', IsShow: true, DataType: 1, width: 66 },
      { Key: 'IsRead', Name: '是否读取', IsShow: true, DataType: 1, width: 66 },
      { Key: 'IsEnable', Name: '是否可用', IsShow: true, DataType: 1, width: 66 },
    ...
    this.Data = await handler.DoMethodReturnJson<Recordable[]>('SelectOneUser_Init');
