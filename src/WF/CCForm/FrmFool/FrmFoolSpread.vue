    ...
    <div  :class="fwcRight?'split-layout':''">
      <div :class="FWCGroupFiled==null || fwcRight==false?'':'left-pane'" style="background-color: white;">
        <div v-for="gf in frmConfigs.gfs" :key="gf.OID">
          <div v-if="!gf.Lab && frmConfigs.gfs.length === 1" style="padding-top: 1.2em"></div>
          <div v-if="!!gf.Lab && gf.ShowType != 2 && gf.CtrlType != 'Dtl' &&(gf.CtrlType === 'FWC' && fwcRight)==false" class="GroupBar GroupTitle" :class="frmConfigs.frmStyleContent.GroupTitle">
            <span style="width: 100%">
              ...
              <template v-else>
                <span :class="gf?.isCompare === 1 ? 'title-text' : ''">
                  <span>
                  ...
                  <span v-if="!!gf?.isCompare && gf?.isCompare == 1">
                    <div>
