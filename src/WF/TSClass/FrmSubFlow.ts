...
/// 父子流程
/// </summary>
export class FrmSubFlow extends EntityNodeID {
  constructor(pkval?: number) {
    super('TS.WF.Template.FrmSubFlow', 'BP.WF.Template.SFlow.FrmSubFlow');
    if (!!pkval) {
      this.setPKVal(pkval);
    }
  }
  ...
  public override get EnMap() {
    ...
    map.AddLink(FrmSubFlowAttr.SFLab, '帮助', 'https://ccflow.org', true, GPNReturnType.OpenUrlByNewWindow);

    //map.SetHelperAlert('Name', '');
 ...
 * 父子流程s
 */
export class FrmSubFlows extends EntitiesNodeID {
