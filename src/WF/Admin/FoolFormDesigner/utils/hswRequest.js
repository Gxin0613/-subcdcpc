...
import errorCode from '/@/views/hsw/utils/errorCode.js'
...
service.interceptors.request.use(
  (config) => {
    ...
    if (user.getToken && !isToken) {
      config.headers['Authorization'] = 'Bearer ' + user.getToken; // 让每个请求携带自定义token 请根据实际情况自行修改
