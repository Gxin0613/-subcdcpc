<template>
  <BaseOptions>
    ...
    <n-form-item :label="'数字按钮'" :show-feedback="false">
      <n-switch v-model:value="selectedWidget.inputButton" size="small" @update-value="updateConfigToDatabase('inputButton', $event ? 1 : 0, true)" />
    </n-form-item>
