<template>
  <BaseOptions>
    ...
    <n-form-item :label="'日期格式'" :show-feedback="false">
      <n-select v-model:value="selectedWidget.selectedFormat" :options="selectedWidget.dateFormatOptions" @update-value="updateConfigToDatabase('IsSupperText', $event, false)" />
    </n-form-item>
...
<script lang="ts" setup>
  ...
  import { NInput, NFormItem, NSwitch, NSelect } from 'naive-ui';
