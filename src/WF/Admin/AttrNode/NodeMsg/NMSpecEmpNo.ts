...
// 节点消息
export class NMSpecEmpNo extends EntityMyPK {
  constructor(mypk?: string) {
    super('TS.WF.NMSpecEmpNo');
  ...
  public override get EnMap() {
    ...
    map.AddTBString(PushMsgAttr.PushWayExp1, null, '人员编号', true, true, 0, 2000, 100);
    map.AddTBString(PushMsgAttr.PushWayExp2, null, '名称', true, true, 0, 2000, 100);
