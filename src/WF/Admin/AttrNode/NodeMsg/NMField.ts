...
// 节点消息
export class NMField extends EntityMyPK {
  ...
  public override get EnMap() {
    ...
    map.AddTBString(PushMsgAttr.PushWayExp1, null, '字段', true, true, 0, 2000, 100);
    map.AddTBString(PushMsgAttr.PushWayExp2, null, '中文名', true, true, 0, 2000, 100);
