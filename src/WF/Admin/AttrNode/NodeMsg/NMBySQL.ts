...
// 节点消息
export class NMBySQL extends EntityMyPK {
  ...
  public override get EnMap() {
    ...
    map.AddDDLEntities(PushMsgAttr.PushWayExp1, 'local', '数据源', new SFDBSrc(), true);
    // map.AddTBString(PushMsgAttr.PushWayExp1, null, '字段', true, true, 0, 100, 100);
    map.AddTBStringDoc(PushMsgAttr.PushWayExp2, null, 'SQL表达式', true, true, true);
