...
// 条件
export class CondFrmSFTable extends EntityMyPK {
  constructor(pkval?: string) {
    super('TS.WF.CondFrmSFTable');
  ...
  public override get EnMap() {
    ...
    @notin=不在范围内
    `;
    map.AddDDLStringEnum(CondAttr.FK_Operator, '=', '操作符', expCfg, true, '多个选项，建议使用多个条件。', false);

    //const 操作的值.
    map.AddTBString(CondAttr.OperatorValue, '', '值', true, false, 0, 200, 20, true);

    map.AddTBString(CondAttr.Tag1, '', '外键', false, false, 0, 200, 20, false);
