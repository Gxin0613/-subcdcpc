...
// 条件
export class CondFrmEnumString extends EntityMyPK {
  constructor(pkval?: string) {
    super('TS.WF.CondFrmEnumString');
  ...
  public override get EnMap() {
    ...
    //const sql = `SELECT StrKey as No, Lab as Name FROM Sys_Enum WHERE EnumKey='@Tag1' Order by IntKey `;
    // const sql = `SELECT IntKey as No, Lab as Name FROM Sys_Enum WHERE EnumKey='QJLX' order by IntKey `;
    map.AddDDLSQL(CondAttr.OperatorValue, '', '值', GloWF.SQLOfCondFrmEnumString, true, null, true);
