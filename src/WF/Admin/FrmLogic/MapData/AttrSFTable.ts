...
/// 外键字段
/// </summary>
export class AttrSFTable extends EntityMyPK {
  constructor(mypk?: string) {
    super('TS.FrmUI.AttrSFTable');
  ...
  public override get EnMap() {
    ...
    map.AddTBString(MapAttrAttr.Tip, null, '激活提示', true, false, 0, 400, 120, true);
 ...
 * 外键字段s
 */
export class AttrSFTables extends EntitiesMyPK {
  get GetNewEntity(): EntityMyPK {
    return new AttrSFTable();
  }
  constructor() {
    super();
  }
