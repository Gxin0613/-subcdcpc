...
// VSTOExcel表单模板
export class PrintTemplateVSTOWord extends EntityMyPK {
  // 实体的权限控制
  ...
  constructor(pkval?: string) {
    super('TS.Sys.Printer.PrintTemplateVSTOWord');
