...
// 系统字典表
export class EnTableTree extends EntityNoName {
  constructor(no?: string) {
    super('TS.FrmUI.EnTableTree');
  ...
  public override get EnMap() {
    const map = new Map('Sys_SFTable', '实体字典表Tree');
    ...
    map.AddRM_UrlTabOpen('编辑数据', '/@/WF/Comm/SFTable/EnTableTree.vue');
...
//系统字典表 s
export class EnTableTrees extends EntitiesNoName {
  get GetNewEntity(): EntityNoName {
    return new EnTableTree();
  }
  constructor() {
    super();
  }
