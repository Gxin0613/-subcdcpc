...
// 系统字典表
export class EnTableNoName extends EntityNoName {
  constructor(no?: string) {
    super('TS.FrmUI.EnTableNoName');
  ...
  public override get EnMap() {
    const map = new Map('Sys_SFTable', '实体字典表NoName');
    ...
    map.AddRM_UrlTabOpen('编辑数据', '/@/WF/Comm/SFTable/EnTableNoName.vue');
    // const rm = new RefMethod();
    // rm.Title = '编辑数据';
    // rm.RefMethodType = RefMethodType.Dtl;
    // rm.ClassMethod = 'OpenIt';
    // map.AddRefMethod(rm);
...
//系统字典表 s
export class EnTableNoNames extends EntitiesNoName {
  get GetNewEntity(): EntityNoName {
    return new EnTableNoName();
  }
  constructor() {
    super();
  }
