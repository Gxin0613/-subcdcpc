...
// 系统字典表
export class SFTableNoName extends EntityNoName {
  constructor(no?: string) {
    super('TS.FrmUI.SFTableNoName');
  ...
  public override get EnMap() {
    const map = new Map('Sys_SFTable', '内置字典表NoName');
    ...
    map.AddRM_UrlTabOpen('编辑数据', '/@/WF/Comm/SFTable/SFTableNoName.vue');
...
//系统字典表 s
export class SFTableNoNames extends EntitiesNoName {
  get GetNewEntity(): EntityNoName {
    return new SFTableNoName();
  }
  constructor() {
    super();
  }
