...
/// 绑定函数
/// </summary>
export class RBAttr extends EntityMyPK {
  constructor(pkval?: string) {
    super('TS.MapExt.RBAttr');
  ...
  public override get EnMap() {
    const map = new Map('Sys_MapExt', '联动字段');
    ...
    map.AddBoolean(MapExtAttr.Tag5, false, 'ISOK', true, true);
    ...
    // map.AddRadioBtn(MapExtAttr.Tag1, 0, '状态', true, true, 'RBAttrSta', str, null);
    // map.AddDDLSysEnum(MapExtAttr.Tag3, 0, '状态', true, true, 'RBAttrSta', str, null);
    map.AddRadioBtn(MapExtAttr.Tag3, 0, '状态', true, false, 'RBAttrSta', str);
    ...
    // map.AddDDLSysEnum(RBAttrAttr.RBAttrExcType, 0, '执行类型', true, true, RBAttrAttr.RBAttrExcType, val);
    // map.AddTBStringDoc(RBAttrAttr.Tag1, null, '执行内容1', true, false, true);
    // map.AddTBStringDoc(RBAttrAttr.Tag2, null, '执行内容2', true, false, true);
    map.AddTBAtParas(300);
    //   map.AddRM_GPE(new GPE_RBAttr(), 'icon-drop');
    this._enMap = map;
    return this._enMap;
  }
}
 ...
 * 绑定函数s
 */
export class RBAttrs extends EntitiesMyPK {
