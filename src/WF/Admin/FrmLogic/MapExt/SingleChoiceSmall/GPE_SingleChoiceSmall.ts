...
export class GPE_SingleChoiceSmall extends PageBaseGroupEdit {
  constructor() {
    super('GPE_SingleChoiceSmall');
  ...
  async Init() {
    ...
    await this.entity.InitDataForMapAttr('SingleChoiceSmall', this.GetRequestVal('PKVal'));

    //增加子页面.
    this.AddGroup('A', '小范围单选'); //增加分组.
