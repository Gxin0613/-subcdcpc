...
// 表格弹窗
export class MENoNameP1 extends EntityMyPK {
  constructor(mypk?: string) {
    super('TS.MapExt.MENoNameP1');
  ...
  public override get EnMap() {
    const map = new Map('Sys_MapExt', '编号名称字典(有参)');
    ...
    //查询出来有参数的字典. 并且是1个参数的.
    // const sql1 = `SELECT No,Name FROM Sys_SFTable WHERE IsPara=1 AND No!='Blank' AND CodeStruct=0 `;
    // map.AddDDLSQL('Tag4', null, '字典表(有参1)', sql1, true);
    MapExt.AddAttrSFTable(map, 'Tag4', '字典表', 1);
