...
export class PopTableSearch extends EntityMyPK {
  ...
  public override get EnMap() {
    ...
    //map.AddTBStringDoc(MapExtAttr.Tag2, null, '数据源', true, false, true, this.NoteTag2);
    //map.AddTBStringDoc(MapExtAttr.Tag3, null, '分页总数数据源', true, false, true, this.NoteTag3);
