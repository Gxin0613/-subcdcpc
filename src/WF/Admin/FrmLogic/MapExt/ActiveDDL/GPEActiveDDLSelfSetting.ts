...
// 级联下拉框
export class GPEActiveDDLSelfSetting extends EntityMyPK {
  constructor(mypk?: string) {
    super('TS.MapExt.GPEActiveDDLSelfSetting');
  ...
  public override get EnMap() {
    ...
    map.AddBoolean('IsSelectVal', false, '级联是否默认选择值', true, true, false, false);
    map.AddTBStringDoc(MapExtAttr.Doc, null, '数据源表达式', true, false, true, this.DescDoc);
