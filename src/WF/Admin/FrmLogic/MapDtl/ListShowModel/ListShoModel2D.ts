...
// 节点属性
export class ListShoModel2D extends EntityNoName {
  constructor(pkval?: string) {
    super('TS.Frm.ListShoModel2D', 'BP.Sys.MapDtl');
  ...
  public override get EnMap() {
    ...
    //let sql = `SELECT KeyOfEn as No, Name FROM Sys_MapAttr WHERE FK_MapData='@No' AND UIVisible=1 `;
    map.AddDDLSQL('D1', '', '维度1字段', GloWF.SQLOfListShoModel2D(), true, '见帮助');
    map.AddDDLSQL('D2', '', '维度2字段', GloWF.SQLOfListShoModel2D(), true, '见帮助');
    ...
    map.AddTBAtParas();
    map.ParaFields = ',D1,D2,D1T,D2T,NumberField,NumberFieldT,';
    // //绑定角色.
