...
//关联流程单据
export class BillRefLink extends EntityMyPK {
  constructor(mypk?: string) {
    super('TS.FrmUI.SelfCommonent.BillRefLink');
  ...
  public get EnMap() {
    ...
    //角色选择.
    map.SetPopGroupList('Tag2', GloWF.srcFlowSorts, GloWF.srcFlows, false, '300px', '500px', '选流程', 'icon-drop');
