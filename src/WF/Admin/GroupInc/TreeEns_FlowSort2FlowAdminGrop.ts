 ...
 * 流程类别流程
 */
export class TreeEns_FlowSort2FlowAdminGrop extends PageBaseTreeEns {
  constructor() {
    super('TreeEns_FlowSort2FlowAdminGrop');
    this.PageTitle = '流程模板';
  }
  ...
  override async Init() {
    ...
    this.BtnsOfTableTop = '目录属性,新建流程,导入';
  ...
  public async BtnClick(btnLab: string, treeNodeID: string, itemIDs: string) {
    ...
    if (btnLab === '新建流程') {
      //   const url = '/@/WF/Comm/UIEntity/GroupPageNew.vue?EnName=GPN_NewFlow&SortNo=' + treeNodeID;
