...
// 自动发起设置
export class AutoStartEn5 extends EntityNoName {
  constructor(no?: string) {
    super('TS.AttrFlow.AutoStartEn5');
    this.setPKVal(no);
  }
  ...
  public override get EnMap() {
    const map = new Map('WF_Flow', '自动发起设置');
    map.CodeStruct = '2';
    ...
    //设置那个是参数字段
    // map.ParaFields = ',StartGuidePara1,StartGuidePara2,';
