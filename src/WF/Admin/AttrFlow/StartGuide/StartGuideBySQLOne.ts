...
// 树干叶子弹窗
export class StartGuideBySQLOne extends EntityNoName {
  constructor(no?: string) {
    super('TS.AttrFlow.StartGuideBySQLOne');
  ...
  public override get EnMap() {
    ...
    map.AddDDLEntities('FK_DBSrc', null, '数据源', new SFDBSrc(), true, null, true);
    ...
    map.AddTBString(FlowAttr.StartGuidePara3, null, '装载一行的数据SQL', true, false, 0, 50, 200, true, this.DescTag3);
