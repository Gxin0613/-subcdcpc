  ...
  <div style="background-color: rgb(240, 242, 245)" class="content" :style="contentStyle">
    <Spin :spinning="loading">
      ...
      <template v-else>
        ...
        <ToolBar
          v-if="nodeInfo"
          :pageType="isReadonly === true ? 'MyView' : 'MyFlow'"
          :node-info="nodeInfo"
          :params="query"
          @call-iframe-method="callIframeMethod"
...
<script lang="ts" setup>
  ...
  import { computed, inject, onMounted, provide, reactive, Ref, ref, shallowRef } from 'vue';
  ...
  import { DealExp, GetPara, GetParamsUrl, mobileNavbarVisible } from '/@/utils/gener/StringUtils';
