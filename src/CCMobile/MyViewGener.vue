<template>
  <div>
    ...
    <ToolBar pageType="MyView" :params="query" @ChangeLoading="ChangeLoading" @Save="Save" @VerifyFormData="VerifyFormData" />
  </div>
</template>
...
<script lang="ts" setup>
  ...
  const query = (props.params.hasOwnProperty('WorkID') ? props.params : route.query) || {};
