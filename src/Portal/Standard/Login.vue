...
<script lang="ts" setup>
  ...
  import ForgetPasswordForm from '../login/ForgetPasswordForm.vue';
  import RegisterForm from '../login/RegisterForm.vue';
  import MobileForm from '../login/MobileForm.vue';
  import QrCodeForm from '../login/QrCodeForm.vue';
