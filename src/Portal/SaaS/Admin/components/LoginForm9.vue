    ...
    <from class="box" action="login.html" method="post" ref="formRef" :model="formData">
      <div class="inputBox">
        <div class="inputText">
          ...
          <input type="text" :placeholder="'用户名'" v-model="formData.account" />
        </div>
        <div class="inputText">
      ...
      <input class="loginButton" type="button" :value="'登录'" @click="handleLogin('Standard')" />
    </from>
  </div>
</template>
...
<style lang="less" scoped>
  ...
  #bigBox .loginButton {
    ...
    border-radius: 20px;
    /* 按钮圆角边 */
    background-image: linear-gradient(to right, #29066a 0%, #b8cbb8 0%, #b465da 0%, #cf6cc9 33%, #ee609c 66%, #ee609c 100%);
    /* 按钮颜色 */
  }
</style>
