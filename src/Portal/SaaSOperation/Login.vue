      ...
      <div class="flex h-full position-center">
        <div class="hidden min-h-full pl-4 mr-4 xl:flex xl:flex-col xl:w-6/12 login-left-log">
          ...
          <div class="my-auto cc-content">
            ...
            <div class="mt-4 text-3xl" style="font-size: 45px; font-weight: 700">{{ VITE_GLOB_SX_TITLE }}工作流/表单/低代码</div>
            ...
            <div class="right-move">
              <div class="content-area">
                <div class="mt-4">纯国产.流程引擎中间件.表单引擎中间件.低代码.大屏.报表.快速开发.OA组件.业务组件</div>
                <div class="mt-4">前端:Vue3 + Vue2 + H5 +react </div>
                <div class="mt-4">后端：springboot+ mvc +.net +.netcore</div>
                <div class="mt-4">其他: 微服务+ redis + </div>
                <div class="mt-4">数据库:Mysql,sqlserver,oracle,PG,DM,Kingbase,UX...</div>
              </div>
        ...
        <div class="flex w-full h-full py-5 xl:h-auto xl:py-0 xl:my-0 xl:w-6/12 login-right-form">
          ...
          >
            <LoginForm type="OPLogin" :OrgName="OrgName" :OrgNo="OrgNo" />
          </div>
        </div>
      </div>
...
<script lang="ts" setup>
  ...
  const InitPage = () => {
    // if (!OrgNo) router.replace({ path: '/op' });
  };
