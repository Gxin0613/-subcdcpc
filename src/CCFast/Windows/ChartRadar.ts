...
/// 雷达图
export class ChartRadar extends EntityNoName {
  constructor(pkVal?: string) {
    super('TS.CCFast.Windows.ChartRadar');
    if (!!pkVal) {
      this.setPKVal(pkVal);
    }
  }
  ...
  public override get EnMap() {
    const map = new Map('GPM_WindowTemplate', '雷达图');
    ...
    map.AddBoolean('IsLine', true, '雷达图', true, false);
