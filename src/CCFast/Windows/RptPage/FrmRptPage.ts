...
/// 报表页面
export class FrmRptPage extends EntityNoName {
  constructor(pkVal?: string) {
    super('TS.CCFast.Windows.FrmRptPage');
    if (!!pkVal) {
      this.No = pkVal;
    }
  }
  ...
  public override get EnMap() {
    ...
    map.AddTBString('FrmID', null, '表单名称', false, true, 0, 300, 20, false);
    map.AddTBString('FrmName', null, '表单名称', false, true, 0, 300, 20, true);
