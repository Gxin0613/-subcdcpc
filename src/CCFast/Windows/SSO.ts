...
import { SSODtls } from './SSODtl';

/// HtmlVar信息块
export class SSO extends EntityNoName {
  constructor(pkVal?: string) {
    super('TS.CCFast.Windows.SSO');
    if (!!pkVal) {
      this.No = pkVal;
    }
  }
  ...
  public override get EnMap() {
    // if (this._enMap != null)
    //   return this._enMap;
    const map = new Map('GPM_WindowTemplate', '登录系统');
    //  #region 基本信息.
    ...
    const showAttrs = 'Name,OpenModel,Url,Icon';
    map.AddRM_DtlSearch('详情', new SSODtls(), 'RefPK', '', '', showAttrs, 'icon-drop', true, '');
    // #endregion 更多链接.
 ...
 * SSOs 信息块s
 */
export class SSOs extends EntitiesNoName {
