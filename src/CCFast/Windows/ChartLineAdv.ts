...
/// 高级折线图
export class ChartLineAdv extends EntityNoName {
  constructor(pkVal?: string) {
    super('TS.CCFast.Windows.ChartLineAdv');
    if (!!pkVal) {
      this.setPKVal(pkVal);
    }
  }
  ...
  public override get EnMap() {
    const map = new Map('GPM_WindowTemplate', '折线图');
    ...
    map.AddBoolean('IsLine', true, '高级折线图', true, false);
