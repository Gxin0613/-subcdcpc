...
/// 玫瑰图
export class ChartRose extends EntityNoName {
  constructor(pkVal?: string) {
    super('TS.CCFast.Windows.ChartRose');
    if (!!pkVal) {
      this.setPKVal(pkVal);
    }
  }
  ...
  public override get EnMap() {
    const map = new Map('GPM_WindowTemplate', '玫瑰图');
    ...
    map.AddBoolean('IsPie', true, '玫瑰图', true, false);
