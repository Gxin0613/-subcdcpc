...
/// 表格
export class WinTable extends EntityNoName {
  constructor(pkVal?: string) {
    super('TS.CCFast.Windows.WinTable');
    if (!!pkVal) {
      this.No = pkVal;
    }
  }
  ...
  public override get EnMap() {
    // if (this._enMap != null)
    //   return this._enMap;
    const map = new Map('GPM_WindowTemplate', '表格');
 ...
 * 表格s
 */
export class WinTables extends EntitiesNoName {
