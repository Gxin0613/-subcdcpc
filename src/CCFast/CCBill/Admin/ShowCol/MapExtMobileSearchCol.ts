...
/// 节点表单属性
export class MapExtMobileSearchCol extends EntityMyPK {
  constructor(pkval?: string) {
    super('TS.CCBill.Admin.MapExtMobileSearchCol');
  ...
  public override get EnMap() {
    const map = new Map('Sys_MapExt', '字段列显示2');
 ...
 * 节点表单属性s
 */
export class MapExtMobileSearchCols extends EntitiesMyPK {
  get GetNewEntity(): EntityMyPK {
    return new MapExtMobileSearchCol();
  }
  constructor() {
    super();
  }
