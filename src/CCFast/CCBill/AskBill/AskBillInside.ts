...
// 调查问卷
export class AskBillInside extends EntityMyPK {
  constructor(no?: string) {
    super('TS.AskFrm.AskBillInside');
    this.setPKVal(no);
  }
  ...
  public override get EnMap() {
    const map = new Map('Frm_GenerAskFrm', '单据内部人员');
    ...
    map.AddDDLSysEnum('AskFrmState', 0, '状态', true, false, 'AskFrmState', '@0=设计中@1=运行中@2=已完成');
