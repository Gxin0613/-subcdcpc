...
<script lang="ts" setup>
  ...
  const openDictSettings = () => {
    wrapperRef.value?.handleGPNCallback(new GPNReturnObj(GPNReturnType.Replace, GloComm.UrlEn('TS.CCBill.DictSettingOne', getParams('FrmID'))));
  };
