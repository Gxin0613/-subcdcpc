...
// 连接
export class MethodLink extends EntityNoName {
  constructor(no?: string) {
    super('TS.CCBill.MethodLink');
    this.setPKVal(no);
  }
  ...
  public override get EnMap() {
    const map = new Map('Frm_Method', '连接');
    ...
    map.AddTBString(MethodAttr.Docs, null, '链接地址', true, false, 0, 300, 10, true);
