...
// 集合方法
export class DBRoleStation extends EntityMyPK {
  constructor(pkval?: string) {
    super('TS.CCBill.DBRoleStation');
  ...
  public override get EnMap() {
    ...
    map.AddTBString('Docs', null, '岗位', true, false, 0, 5000, 10, true, null);
    map.SetPopGroupList('Docs', GloWF.srcStationTypes, GloWF.srcStations, true, '800px', '1000px', '选择岗位', 'icon-people');
...
//集合方法s
export class DBRoleStations extends EntitiesMyPK {
  get GetNewEntity(): EntityMyPK {
    return new DBRoleStation();
  }
  constructor() {
    super();
  }
