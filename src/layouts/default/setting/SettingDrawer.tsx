...
export default defineComponent({
  ...
  setup(_,{ attrs }) {
    ...
    const isStandardMode = computed(() => {
      ...
      return !(route.path.startsWith('/portal') || route.path.startsWith('/Middle'))
    });
    ...
    return () => (
      <BasicDrawer {...attrs} title={'项目配置'} width={330} class="setting-drawer">
        ...
        {isStandardMode.value ? <Divider>{() => '导航栏模式'}</Divider> : <br />}
        {isStandardMode.value ? renderSidebar() : <br />}
