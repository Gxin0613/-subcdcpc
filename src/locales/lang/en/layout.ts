export default {
  ...
  header: {
    ...
    goToMiddleware: 'Switch Middleware Mode',
    goToPortal: 'Switch Portal Mode',
    goToStandard: 'Switch Low-Code',
    goToMobile: 'Swith Mobile',
    mySetting: 'My Setting',
    styleSetting: 'Style Settings',
    changeDept: 'Switch Department ',
    changeOrgAdmin: 'Manage Organization(AdminOnly)',
    document: 'Document',
    //多语言
    MultilingualDropDown: 'Multilingual',
