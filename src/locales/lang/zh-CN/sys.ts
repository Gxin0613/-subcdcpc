export default {
  ...
  login: {
    ...
    signInTitle: '低代码开发平台/流程中间件 CCFast',
    signInDesc: '',
    policy: '我同意xxx隐私政策',
    scanSign: `扫码后点击“确认”，即可完成登录`,

    loginButton: '登录-低代码平台',
    loginButtonPortal: '登录-门户',
    registerButton: '注册',
    loginMiddlewareButton: '登录-流程中间件',
    loginMobileButton: '移动端登录',
    rememberMe: '记住我',
    forgetPassword: '忘记密码？',
    otherSignIn: '其他登录方式',
    loginPortal: '登录-门户平台(开发中)',

    qywxIntegration: '企业微信集成',
