...
namespace TS.DA
{
    ...
    public class Paras : System.Collections.CollectionBase
    {
        ...
        public string SQLNoPara
        {
            get
            {
                ...
                foreach (Para p in this)
                {
                    ...
                    {
                        if (mysql.Contains(TS.Difference.SystemConfig.AppCenterDBVarStr + p.ParaName + ","))
                            mysql = mysql.Replace(TS.Difference.SystemConfig.AppCenterDBVarStr + p.ParaName + ",", "'" + p.val.ToString() + "',");
                        else
                            mysql = mysql.Replace(TS.Difference.SystemConfig.AppCenterDBVarStr + p.ParaName, "'" + p.val.ToString() + "'");
                    }
                    else
        ...
        public string DBStr
        {
            get
            {
                return TS.Difference.SystemConfig.AppCenterDBVarStr;
            }
        }
        /// <summary>
        /// 实例化参数
