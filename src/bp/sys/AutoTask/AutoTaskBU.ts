...
// 自动任务
export class AutoTaskBU extends EntityMyPK {
  constructor(no?: string) {
    super('TS.Sys.AutoTaskBU');
  ...
  public override get EnMap() {
    ...
    map.AddTBString('Docs', null, '执行内容', true, true, 0, 200, 200);
    map.AddTBString('Times', null, '执行时间', true, false, 0, 200, 20);
    const help = `
    #### 格式约定.
