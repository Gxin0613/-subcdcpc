...
<template>
  <div class="app-container" style="height: 82vh">
      ...
      <pane size="50">
        <el-col>
          <div>
            ...
            <el-table v-loading="loading" :data="batchList" @selection-change="handleSelectionChange" size="small" @cell-click="getDetail"
    ...
    <el-dialog
      ...
      width="650px"
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="85px" size="default" label-position="left">
        <div>
          <el-row>
            <el-col :span="12">
    ...
    >
      <el-row>
        <splitpanes class="default-theme">
          ...
          <pane size="36">
            ...
            <el-form ref="detailForm" :model="detailForm" :rules="rules" label-width="80px" size="default" label-position="left">
      ...
      <!--      </div>-->
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitForm(true)" size="default">保存并继续</el-button>
        <el-button type="primary" @click="submitForm(false)" size="default">确 定</el-button>
        <el-button @click="drawer = false" size="default">关 闭</el-button>
      </div>
    </el-dialog>
...
import {
  ...
  exportBatch,
  importTemplate
} from "/@/api/hsw/cdc/sampleManage/cdcSampleReceiveBatch";
// import {getToken} from "@/utils/auth";

import {Splitpanes, Pane} from "splitpanes"
import "splitpanes/dist/splitpanes.css"
//样品明细
import cdcSampleDetail from '/@/views/hsw/cdc/sampleManage/inspection/cdcSampleDetail.vue'
// import { listDetail, getDetail, delDetail, addDetail, updateDetail, exportDetail } from "@/api/cdc/sampleManage/cdcSampleDetail";
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        sendSampleDate: [{required: false, message: '采样日期不能为空', trigger: 'blur'}],
        inspectionDate: [{required: false, message: '送检日期不能为空', trigger: 'blur'}],
