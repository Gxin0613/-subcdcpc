        ...
        if (row != undefined) {
          ...
          this.methodList.map((item) => {
            if (row.id != item.id) {
              ...
              if (item.expansion) {
                // if(item.name == "菌落总数"){
                //   this.recordList = [{ id: 6, stepName: "样品稀释", status: "已完成",type:0,expansion:false, },
                //     { id: 7, stepName: "培养", status: "进行中",type:1,expansion:false, },
                //     { id: 8, stepName: "结果", status: "未开始",type:0 ,expansion:false,}];
                // }else if(item.name == "大肠菌群"){
                //   this.recordList = [{ id: 6, stepName: "样品稀释", status: "已完成",type:0,expansion:false, },
                //     { id: 7, stepName: "初发酵试验", status: "进行中",type:1,expansion:false, },
                //     { id: 7, stepName: "复发酵试验", status: "进行中",type:1,expansion:false, },
                //     { id: 8, stepName: "结果", status: "未开始",type:0 ,expansion:false,}];
                // }

                // this.$nextTick().then(() => {
                //   this.$refs.detail.queryParams.mainId = row.id;
...
<style scoped lang="scss">
  ...
  ::v-deep(l-table__expand-icon .el-icon-arrow-right) {
    display: none;
  }
