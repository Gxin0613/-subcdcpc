<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="typeList" size="small" @selection-change="handleSelectionChange">
...
<script setup lang="js" name="Dict">
  import useDictStore from '/@/views/hsw/store/modules/dict.js'
  import { listType, getType, delType, addType, updateType, refreshCache } from '/@/api/hsw/cdc/system/dict/type.js';
