...
<script setup name="Data">
  ...
  import { optionselect as getDictOptionselect, getType } from '/@/api/hsw/cdc/system/dict/type';
  import { listData, getData, delData, addData, updateData } from '/@/api/hsw/cdc/system/dict/data';
