...
// 学生考核
export class KaoHeFixDtl extends EntityMyPK {
  constructor(pkval?: string) {
    super('TS.Demo.KaoHeFixDtl');
  ...
  public override get EnMap() {
    ...
    map.CodeStruct = '3';
    map.AddMyPK();
    map.AddTBString('StudentNo', null, '学生编号', false, false, 0, 600, 600);
    map.AddDDLEntities('Sort1', null, '大类', new Sort1(), true);
    map.AddDDLEntities('Sort2', null, '小类', new Sort2(), true);

    map.AddTBString('Checker', null, '考核人', true, false, 0, 20, 300); //年月.
    map.AddTBString('CheckNote', null, '考核备注', true, false, 0, 20, 300); //年月.
...
//学生考核s
export class KaoHeFixDtls extends EntitiesMyPK {
  get GetNewEntity(): EntityMyPK {
    return new KaoHeFixDtl();
  }
  constructor() {
    super();
  }
