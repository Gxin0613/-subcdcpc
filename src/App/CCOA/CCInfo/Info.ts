...
export class Info extends EntityNoName {
  ...
  public override get EnMap() {
    ...
    map.AddAthSingle('Ath', '附件', false, true, '*.*');
    map.AddDDLSysEnum('InfoPRI', 0, '重要性', true, true, 'InfoPRI', '@0=普通@1=紧急@2=火急');
    ...
    map.AddTBInt('ReadTimes', 0, '读取次数', true, true);
    map.AddDDLSysEnum('InfoSrcType', 0, '数据源类型', true, true, 'InfoSrcType', '@0=文章@1=文件@2=链接');
    ...
    map.AddSearchAttr('InfoSta');
    map.AddSearchAttr('InfoType');
    map.AddSearchAttr('InfoPRI');
